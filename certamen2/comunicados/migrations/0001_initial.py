    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario_admin', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comunicado',
            fields=[
                ...
                ('entidad', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='comunicados.entidad')),
